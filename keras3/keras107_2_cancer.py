...
model.fit(x_train, y_train, epochs=10, validation_split=0.2, callbacks=[stop, lr])
results = model.evaluate(x_test, y_test)
print(results)

best_model = model.tuner.get_best_model()
best_model.save('./test_auto/save/cancer.h5')

# [0.1054399311542511, 0.9824561476707458]


from tensorflow.keras.models import load_model
l_model = load_model('./test_auto/save/cancer.h5')
