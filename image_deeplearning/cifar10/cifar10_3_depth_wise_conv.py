...
model.add(Conv2D(32,(5,5),activation='relu',padding='same'))
model.add(BatchNormalization())
model.add(DepthwiseConv2D(32,(5,5),activation='relu',padding='same'))
model.add(BatchNormalization())
...
model.add(BatchNormalization())
model.add(DepthwiseConv2D(64,(5,5),activation='relu',padding='same')) 
model.add(BatchNormalization())
# model.add(MaxPooling2D((3,3)))
...
# 다 Depthwisecon2D 하면 성능이 훨씬 낮았다. 
# [0.8078545928001404, 0.7355999946594238]
# cifar10_3_depth_wise_conv 에서 depthwisecon2d 를 섞어 봤는데 엄청느리고 성능은 낮았다.. 