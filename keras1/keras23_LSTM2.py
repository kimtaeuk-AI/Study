...
from tensorflow.keras.layers import Dense, LSTM             #LSTM은 *3차원*을 받아들인다. , Dense 는 2차원 RNN 4차원 ?

model = Sequential()

# model.add(LSTM(10, activation='relu', input_shape=(3,1)))   # input_shape는 한차원씩 줄어든다. 1개의 timestep이 3개있음 
model.add(LSTM(10, activation='relu', input_length=3, input_dim=1)) #input_dim 아니면 안될때 intput_length를 사용한다        
