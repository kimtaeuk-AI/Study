...
from tensorflow.keras.layers import Dense, LSTM, SimpleRNN             #LSTM은 *3차원*을 받아들인다. , Dense 는 2차원 RNN 4차원 ?

model = Sequential()

model.add(SimpleRNN(10, activation='relu', input_shape=(3,1)))   # input_shape는 한차원씩 줄어든다. 1개의 timestep이 3개있음 
